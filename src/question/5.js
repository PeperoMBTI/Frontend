...
function FivePage() {
  ...
  const first = () => {
    ...
    navigate('/6', { state: { dataCounts: { ...dataCounts, E: dataCounts.E + 1 } } });
  };
  const second = () => {
    setDataCounts((prevCounts) => ({
      ...prevCounts,
    ...
    console.log('Current dataCounts:', dataCounts);
    navigate('/6', { state: { dataCounts: { ...dataCounts, I: dataCounts.I + 1 } } });
  };

  return (
    <div className='container'>
      <div className="pepero-image-container">
        <img src='/pepero/ESFJ.png' alt="결과 이미지" className="pepero-image" />
      </div>
