...
function EsfjPage() {
  ...
  const save = () => {
    ...
    if (isIOS) {
      ...
      window.open("/result/ESFJ.png", '_blank');
    } else {
      const link = document.createElement('a');
      link.href = "/result/ESFJ.png";
      link.download = "pepero-mbti-ESFJ.png";
      link.click();
    }
  };
  ...
  return (
    <div className="image-container">
      <img src="/result/ESFJ.png" alt="결과 이미지" className="result-image" />
