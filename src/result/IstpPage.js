...
function IstpPage() {
  ...
  const save = () => {
    ...
    if (isIOS) {
      ...
      window.open("/result/ISTP.png", '_blank');
    } else {
      const link = document.createElement('a');
      link.href = "/result/ISTP.png";
      link.download = "pepero-mbti-ISTP.png";
      link.click();
    }
  };
  ...
  return (
    <div className="image-container">
      <img src="/result/ISTP.png" alt="결과 이미지" className="result-image" />
