...
function IsfjPage() {
  ...
  const save = () => {
    ...
    if (isIOS) {
      ...
      window.open("/result/ISFJ.png", '_blank');
    } else {
      const link = document.createElement('a');
      link.href = "/result/ISFJ.png";
      link.download = "pepero-mbti-ISFJ.png";
      link.click();
    }
  };
  ...
  return (
    <div className="image-container">
      <img src="/result/ISFJ.png" alt="결과 이미지" className="result-image" />
